...
const board = {
    ...
    threads: [{
        ...
        replies: [{
            ...
            file: "https://engineering.asu.edu/wp-content/uploads/2019/10/weevil-shutterstock_749333035w.jpg"
        }, {
            id: 6,
            user: {
                name: "Anonymous",
            ...
            date: "12/04/2022 00:64",
            content: "little critter",
            file: "http://www.biobestgroup.com/public/uploads/images/pests/red-palm-weevil-rhynchophorus-ferrugineus-01.jpg "
        }, {
            id: 12,
            user: {
                name: "Anonymous",
...
<div class="thread-info" hidden>File: <a href="https://pbs.twimg.com/media/EXFXCnWXkAEZKDQ.jpg">https://pbs.twimg.com/media/EXFXCnWXkAEZKDQ.jpg</a> (33.2KB, 591x512)</div>
    ...
    */
    ...
    span0.classList.add("thread-title")
    ...
    id.classList.add("thread-op-tag")
